...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        C, H, W = input_dim
        self.params['W1'] = \
            weight_scale * np.random.randn(num_filters, C,
                                           filter_size, filter_size)
        self.params['b1'] = np.zeros(num_filters)

        self.params['W2'] = \
            weight_scale * np.random.randn((H / 2) * (W / 2) * num_filters,
                                           hidden_dim)
    ...
    def loss(self, X, y=None):
        ...
        # conv - relu - 2x2 max pool - affine - relu - affine - softmax
        conv_1, cache_1 = conv_relu_pool_forward(
            X, W1, b1, conv_param, pool_param)
        affine_1, cache_2 = affine_relu_forward(conv_1, W2, b2)
        scores, cache_3 = affine_forward(affine_1, W3, b3)
        ...
        dX3, dW3, db3 = affine_backward(dout, cache_3)
