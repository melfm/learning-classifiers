...
class KNearestNeighbor(object):
    ...
    def train(self, X, y):
        ...
        Inputs:
        - X: A numpy array of shape (num_train, D) containing the training
            data consisting of num_train samples each of dimension D.
    ...
    def compute_distances_no_loops(self, X):
        ...
        X_train_term = np.sum(self.X_train**2, axis=1)
        dists = np.sqrt((X_term + X_train_term) - dot_prod)
        return dists
