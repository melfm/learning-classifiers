...
#HalfCheetah
python train_pg_f18.py HalfCheetah-v2 -ep 150 --discount 0.9 -n 100 -e 3 -l 2 -s 64 -b 10000 -lr 0.005 -rtg --exp_name hc_b10000_r0.005

python train_pg_f18.py HalfCheetah-v2 -ep 150 --discount 0.9 -n 100 -e 3 -l 2 -s 64 -b 10000 -lr 0.01 -rtg --exp_name hc_b10000_r0.01

python train_pg_f18.py HalfCheetah-v2 -ep 150 --discount 0.9 -n 100 -e 3 -l 2 -s 64 -b 10000 -lr 0.02 -rtg --exp_name hc_b10000_r0.002



python train_pg_f18.py HalfCheetah-v2 -ep 150 --discount 0.9 -n 100 -e 3 -l 2 -s 64 -b 30000 -lr 0.005 -rtg --exp_name hc_b30000_r0.005

python train_pg_f18.py HalfCheetah-v2 -ep 150 --discount 0.9 -n 100 -e 3 -l 2 -s 64 -b 30000 -lr 0.01 -rtg --exp_name hc_b30000_r0.01

python train_pg_f18.py HalfCheetah-v2 -ep 150 --discount 0.9 -n 100 -e 3 -l 2 -s 64 -b 30000 -lr 0.02 -rtg --exp_name hc_b30000_r0.002



python train_pg_f18.py HalfCheetah-v2 -ep 150 --discount 0.9 -n 100 -e 3 -l 2 -s 64 -b 50000 -lr 0.005 -rtg --exp_name hc_b50000_r0.005

python train_pg_f18.py HalfCheetah-v2 -ep 150 --discount 0.9 -n 100 -e 3 -l 2 -s 64 -b 50000 -lr 0.01 -rtg --exp_name hc_b50000_r0.01

python train_pg_f18.py HalfCheetah-v2 -ep 150 --discount 0.9 -n 100 -e 3 -l 2 -s 64 -b 50000 -lr 0.02 -rtg --exp_name hc_b50000_r0.002
